...
class Video(models.Model):
    page = models.ForeignKey(Page, verbose_name='Страница', related_name='videos', on_delete=models.CASCADE)
    title = models.CharField('Заголовок', max_length=255)
...
class Audio(models.Model):
    page = models.ForeignKey(Page, verbose_name='Страница', related_name='audios',
...
class Text(models.Model):
    page = models.ForeignKey(Page, verbose_name='Страница', related_name='texts',
                             on_delete=models.CASCADE)
